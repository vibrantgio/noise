...
noise: `workbench/launcher` uses it for its animated background, and two
example programs under `seen/context/gio` use it for their surfaces. One
module, one package, standard library only — it depends on nothing.
